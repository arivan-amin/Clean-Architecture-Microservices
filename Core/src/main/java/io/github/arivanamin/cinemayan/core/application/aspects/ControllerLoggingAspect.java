package io.github.arivanamin.cinemayan.core.application.aspects;

import io.github.arivanamin.cinemayan.core.application.audit.AuditDataExtractor;
...
import io.github.arivanamin.cinemayan.core.domain.command.create.CreateAuditOutboxMessageInput;
...
import static io.github.arivanamin.cinemayan.core.domain.aspects.ExecutionWrapper.executeThrowable;
