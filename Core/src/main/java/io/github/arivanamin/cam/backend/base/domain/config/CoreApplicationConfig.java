...
public final class CoreApplicationConfig {
    ...
    public static final String APPLICATION_DIRECTORY_NAME = "Clean-Architecture-Microservices";

    public static final String BASE_PACKAGE = "io.github.arivanamin.cam.backend";
