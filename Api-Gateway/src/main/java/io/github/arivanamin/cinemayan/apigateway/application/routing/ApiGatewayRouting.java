package io.github.arivanamin.cinemayan.apigateway.application.routing;

import io.github.arivanamin.cinemayan.apigateway.application.config.EurekaProperties;
