package io.github.arivanamin.scm.backend.patient.application.config;
...
public final class PatientApiURLs {
    ...
    public static final String GET_PATIENT_BY_ID_URL = PROTECTED_API + ACCOUNT_BY_ID;
    public static final String CREATE_PATIENT_URL = PROTECTED_API + "/v1/accounts";
    public static final String UPDATE_PATIENT_URL = PROTECTED_API + ACCOUNT_BY_ID;
    public static final String DELETE_PATIENT_URL = PROTECTED_API + ACCOUNT_BY_ID;
}
