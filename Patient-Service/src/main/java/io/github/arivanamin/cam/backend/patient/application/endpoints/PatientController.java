package io.github.arivanamin.cam.backend.patient.application.endpoints;

import io.github.arivanamin.cam.backend.base.domain.pagination.PaginationCriteria;
import io.github.arivanamin.cam.backend.patient.application.request.CreatePatientRequest;
import io.github.arivanamin.cam.backend.patient.application.request.UpdatePatientRequest;
import io.github.arivanamin.cam.backend.patient.application.response.*;
import io.github.arivanamin.cam.backend.patient.core.command.*;
import io.github.arivanamin.cam.backend.patient.core.query.ReadPatientByIdQuery;
import io.github.arivanamin.cam.backend.patient.core.query.ReadPatientsQuery;
...
import static io.github.arivanamin.cam.backend.patient.application.config.PatientApiURLs.*;
import static io.github.arivanamin.cam.backend.patient.application.config.PatientCaches.GET_ALL_PATIENTS_CACHE;
import static io.github.arivanamin.cam.backend.patient.application.config.PatientCaches.GET_PATIENT_BY_ID_CACHE;
