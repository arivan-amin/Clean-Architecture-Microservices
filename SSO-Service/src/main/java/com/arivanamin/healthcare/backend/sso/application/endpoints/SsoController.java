package com.arivanamin.healthcare.backend.sso.application.endpoints;

import com.arivanamin.healthcare.backend.sso.application.request.CreateClientRequest;
import com.arivanamin.healthcare.backend.sso.application.response.ClientResponse;
import com.arivanamin.healthcare.backend.sso.application.response.CreateClientResponse;
...
import static com.arivanamin.healthcare.backend.sso.application.config.SsoApiURLs.CREATE_CLIENT_URL;
import static com.arivanamin.healthcare.backend.sso.application.config.SsoApiURLs.GET_CLIENT_BY_ID_URL;
