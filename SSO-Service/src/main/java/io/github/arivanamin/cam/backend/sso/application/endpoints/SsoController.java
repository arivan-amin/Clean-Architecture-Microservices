package io.github.arivanamin.cam.backend.sso.application.endpoints;

import io.github.arivanamin.cam.backend.sso.application.request.CreateClientRequest;
import io.github.arivanamin.cam.backend.sso.application.response.ClientResponse;
import io.github.arivanamin.cam.backend.sso.application.response.CreateClientResponse;
...
import static io.github.arivanamin.cam.backend.sso.application.config.SsoApiURLs.CREATE_CLIENT_URL;
import static io.github.arivanamin.cam.backend.sso.application.config.SsoApiURLs.GET_CLIENT_BY_ID_URL;
