package io.github.arivanamin.cinemayan.catalog.application.endpoints;

import io.github.arivanamin.cinemayan.catalog.application.request.CreateStudentRequest;
import io.github.arivanamin.cinemayan.catalog.application.request.UpdateStudentRequest;
import io.github.arivanamin.cinemayan.catalog.application.response.*;
import io.github.arivanamin.cinemayan.catalog.domain.command.create.*;
import io.github.arivanamin.cinemayan.catalog.domain.command.delete.DeleteStudentCommand;
import io.github.arivanamin.cinemayan.catalog.domain.command.delete.DeleteStudentInput;
import io.github.arivanamin.cinemayan.catalog.domain.command.update.UpdateStudentCommand;
import io.github.arivanamin.cinemayan.catalog.domain.command.update.UpdateStudentInput;
...
import io.github.arivanamin.cinemayan.catalog.domain.query.readbyid.*;
import io.github.arivanamin.cinemayan.catalog.domain.query.readbyspec.*;
...
import static io.github.arivanamin.cinemayan.catalog.application.config.StudentApiURLs.*;
import static io.github.arivanamin.cinemayan.catalog.application.config.StudentCaches.GET_ALL_STUDENTS_CACHE;
import static io.github.arivanamin.cinemayan.catalog.application.config.StudentCaches.GET_STUDENT_BY_ID_CACHE;
