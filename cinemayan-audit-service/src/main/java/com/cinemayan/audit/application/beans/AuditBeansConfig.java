package com.cinemayan.audit.application.beans;
...
import com.cinemayan.audit.domain.query.readbyid.ReadAuditEventByIdQuery;
import com.cinemayan.audit.domain.query.readbyspec.ReadAuditEventsQuery;
import com.cinemayan.audit.infrastructure.AuditEventRepository;
import com.cinemayan.audit.infrastructure.JpaAuditEventStorage;
