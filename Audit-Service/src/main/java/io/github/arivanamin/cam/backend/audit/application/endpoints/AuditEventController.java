package io.github.arivanamin.cam.backend.audit.application.endpoints;

import io.github.arivanamin.cam.backend.audit.application.request.AuditEventCriteria;
import io.github.arivanamin.cam.backend.audit.application.response.AuditEventResponse;
import io.github.arivanamin.cam.backend.audit.application.response.ReadAuditEventsResponse;
...
import static io.github.arivanamin.cam.backend.audit.application.config.AuditApiURLs.*;
