package io.github.arivanamin.lms.backend.patient.application.endpoints;

import io.github.arivanamin.lms.backend.base.core.pagination.PaginationCriteria;
import io.github.arivanamin.lms.backend.patient.application.request.CreatePatientRequest;
import io.github.arivanamin.lms.backend.patient.application.request.UpdatePatientRequest;
import io.github.arivanamin.lms.backend.patient.application.response.*;
...
import static io.github.arivanamin.lms.backend.patient.application.config.PatientApiURLs.*;
import static io.github.arivanamin.lms.backend.patient.application.config.PatientCaches.GET_ALL_PATIENTS_CACHE;
import static io.github.arivanamin.lms.backend.patient.application.config.PatientCaches.GET_PATIENT_BY_ID_CACHE;
